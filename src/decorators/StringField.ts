...
import { FieldType, decoratorDefaults, DecoratorDefaults } from '../metadata';
import { composeMethodDecorators } from '../utils';
import { StringColumnType } from '../torm';

import { getCombinedDecorator } from './getCombinedDecorator';

interface StringFieldOptions extends DecoratorDefaults<boolean | FieldType> {
